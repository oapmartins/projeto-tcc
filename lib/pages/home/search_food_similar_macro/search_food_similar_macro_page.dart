...
class SearchFoodSimilarMacroPage extends StatefulWidget {
  const SearchFoodSimilarMacroPage({super.key});

  @override
  State<SearchFoodSimilarMacroPage> createState() => _SearchFoodSimilarMacroPageState();
}

class _SearchFoodSimilarMacroPageState extends State<SearchFoodSimilarMacroPage> {
  @override
  void initState() {
    Get.find<SearchFoodSimilarMacroController>().idRefSelected = Get.arguments['ref_id'];
    Get.find<SearchFoodSimilarMacroController>().searchFoodsSimilarMacro(
      similarMacro: Get.arguments['similarMacro'],
    );
    super.initState();
  }
  ...
  @override
  void dispose() {
    Get.find<SearchFoodSimilarMacroController>().clearList();
    super.dispose();
  }
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        body: GetBuilder(builder: (SearchFoodSimilarMacroController controller) {
                        ...
                        child: ListTile(
                          ...
                          trailing: IconButton(
                            onPressed: () async {
                              ...
                              Get.toNamed('add-food-similar-macro');
                            },
                            icon: const Icon(
